...
export default function completeInfo() {
    ...
    const handleNext = () => {
        if (!birthday || !phone || !address || !typePerson || !gender) {
            Alert.alert("Campos incompletos", "Por favor, completa todos los campos obligatorios antes de continuar.");
            return;
        }
        router.push("/profile");
    };
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                <View style={styles.formContainer}>
                    ...
                    <Text style={styles.subtitle}>
                        Para continuar, por favor ingresa los siguientes datos y asegúrate de que tu información sea correcta.
                    </Text>

                    {/* FECHA DE NACIMIENTO */}
                    <TouchableOpacity onPress={() => setShowDatePicker(true)} style={styles.dateInput}>
                        <Text style={styles.dateText}>
                            {birthday ? birthday.toLocaleDateString() : "fecha de nacimiento *"}
                        </Text>
                    </TouchableOpacity>
                    {showDatePicker && (
                        <DateTimePicker
                    ...
                    {/* 📸 SECCIÓN DE IMAGEN */}
                    <Text style={styles.subtitle}>Subir una foto de perfil (Opcional)</Text>
                    <View style={styles.imageUploadContainer}>
                        <Text style={styles.uploadText}>
                            {imageName ? "Imagen seleccionada" : "Selecciona la imagen aquí"}
                        </Text>
