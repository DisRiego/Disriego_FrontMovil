...
export async function generatePropertyPDF(propertyData: {
    ...
    const locationNames = await fetchLocationNames(company.country, company.state, company.city);
...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right">
            ...
            <div class="generateby">
                ${locationNames.city}, ${locationNames.department}, ${locationNames.country}<br />
                ${company.address}<br />
                ${company.phone}<br />
                ${company.nit}
            </div>
    ...
    <div class="container">
        ...
        <div class="owner-info">
            <div class="column">
                <p><strong>Nombre completo:</strong><br />${user.name} ${user.first_last_name} ${user.second_last_name || ""}</p>
                <p><strong>Dirección de correspondencia:</strong><br />${user.address || "No disponible"}</p>
            </div>
            <div class="column">
                <p><strong>Número de documento:</strong><br />${user.document_number || "No disponible"}</p>
                <p><strong>Teléfono:</strong><br />${user.phone || "No disponible"}</p>
            </div>
        </div>
